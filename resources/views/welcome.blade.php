...
@endguest
                  ...
                  <div class="carousel-item active">
                    <div class="banner_bg">
                      <div class="banner_taital_main">
                        ...
                        <p class="long_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum</p>
                        <div class="btn_main">
                          <div class="about_us"><a href="/patient/find-doctor">Find doctor</a></div>
                          <div class="about_bt"><a href="/patient/find-doctor">Get Appointment</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="services_section layout_padding">
        <div class="container">
            <center><B><h1>Services</h1></b></center>
          <div class="row">
            <div class="col-lg-4">
              <div class="call_box">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="appointment_bt_main">
                <div class="appointment_bt"><a href="/patient/find-doctor">Get Appointment</a></div>
              </div>
            </div>
          </div>
        </div>
